...
import { Tag, Plus, Pencil, Trash2, ToggleLeft, ToggleRight, Loader2, AlertCircle, X, CheckCircle } from "lucide-react";
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div>
                ...
                <p className="text-sm text-gray-400 mt-1">Manage item categories used across the platform</p>
            </div>
